...
$done({
  ...
  content: today(tnumcount(nowlist)) + " | " + tlist[nowlist][0] + "\n" + tnumcount(Number(nowlist) + Number(1)) + "天" + " | " + tlist[Number(nowlist) + Number(1)][0] + "\n" + tnumcount(Number(nowlist) + Number(2)) + "天" + " | " + tlist[Number(nowlist) + Number(2)][0]
})
